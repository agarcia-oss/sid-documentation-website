	...
	[
		{
			...
			setUp: function(){
				...
				dojo.forEach(partLocaleList, function(locale){
					dojo.requireLocalization("dojo.cldr", "gregorian", locale, "aa,af,am,ar,ar-jo,ar-lb,ar-qa,ar-sa,ar-sy,ar-tn,ar-ye,as,be,bg,bn,bo,byn,ca,cs,cy,da,de,de-at,de-be,el,el-polyton,en,en-au,en-be,en-bw,en-bz,en-ca,en-gb,en-hk,en-ie,en-in,en-mt,en-nz,en-pk,en-sg,en-za,en-zw,eo,es,es-ar,es-cl,es-co,es-ec,es-es,es-gt,es-hn,es-pa,es-pe,es-pr,es-us,et,eu,fa,fa-af,fi,fil,fo,fr,fr-be,fr-ca,fr-ch,ga,gl,ROOT,gu,gv,haw,he,hi,hr,hu,hy,hy-am-revised,id,ii,is,it,it-ch,it-it,ja,ka,kk,kl,km,kn,ko,ko-kr,kok,kw,lt,lv,mk,ml,mn,mr,ms,ms-bn,mt,nb,ne,nl,nl-be,nn,om,pa,pa-arab,pa-pk,pl,ps,pt,pt-br,pt-pt,ro,ru,ru-ua,se-fi,sh,sh-cs,sh-yu,sk,sl,so,sq,sr,sr-ba,sr-cyrl-ba,sr-latn,sr-latn-cs,sr-latn-me,sr-latn-rs,sr-latn-yu,sv,sv-fi,sw,ta,te,th,ti,ti-er,tr,uk,ur,uz-latn,vi,zh,zh-cn,zh-hans-sg,zh-hant,zh-hant-hk,zh-hant-mo,zh-hk,zh-mo,zh-sg,zh-tw");
				});
			},
			runTest: function(t){
			},
